...
outputs:
	return {"adjustments":adjustments,"between_adjustments":between_adjustments}, line 137, type dict: {"adjustments":adjustments as [[date as datetime.datetime, closing price as float], ...], "between_adjustments": time between adjustments as [[date as datetime.datetime, closing price as float], ...]}
...
def market_adjustment(market_type: "bull | bear", margin: float, 
	...
	# If still in adjustment when we reach the end, set the end point of adjustments to the last point,
	# otherwise set the end point of between_adjustments to the last point.
