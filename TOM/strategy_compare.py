...
I want to plot the returns of the various methods and also generate the 
expected value.
...
def main():
	...
	#####
	#
	# Compare different start/end date strategies
	# Also want to consider buy/sell times
	#
	#####
	
	# Based on results from plot_daily_returns, the best avg returns occur on days
	# -4 to +1
	start_end=[[-5,-1],[-5,0],[-5,1],[-4,-1],[-4,0],[-4,1]
