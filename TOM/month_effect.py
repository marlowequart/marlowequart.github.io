...
This script currently looks at one month (turn of year) of the given year but can be extrapolated out to more months
...
def main():
	...
	print()
	print('Month under test: '+test_month+', from '+start_date+' to '+end_date)
	print('Purchase on day '+str(start_day)+', hold for '+str(num_days-start_day)+' days')
