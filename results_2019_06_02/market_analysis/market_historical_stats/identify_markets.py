...
inputs:
	...
	lower, line 32, type float: fraction of recent maximum price to be used as an 
		indicator of transition from bear to bull market as float
	upper, line 33, type float: fraction of recent minimum price to be used as an 
		indicator of transition from bull to bear market as float

outputs:
	return {"bull_markets":bulls, "bear_markets":bears}, line 107, 
